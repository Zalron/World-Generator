...
namespace VoxelPlay {
	...
	public static class RenderTypeExtensions {
		...
		public static bool supportsSeeThrough(this RenderType o) {
	...
	public partial class VoxelDefinition : ScriptableObject {
		...
		[Tooltip("Alpha multiplier to the global see-through setting in Voxel Play Environment.")]
		public float seeThroughAlphaMultiplier = 1f;
